...
*/
#ifndef SOPWITH_SOUNDSYS_H
#define SOPWITH_SOUNDSYS_H
...
extern int numfrags;
extern Tune explosion;
extern const unsigned int movingplanebasesound;
extern const unsigned int planespeedsoundmultiplier;
