...
5. [x] Remove Allegro and DJGPP code
6. [x] Remove Allegro toolchain
7. [ ] Reproducible Windows build instructions for building with SDL + Network code (build but untested)                

**Exit criteria**
- Fresh machine can build and run from documented SDL steps and network build path
